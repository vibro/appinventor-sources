...
Blockly.Language.lists_pick_an_item = {
  ...
  helpUrl: function() {
      ...
      return Blockly.Language.lists_pick_an_item.HELPURLS[mode];
  },
  init : function() {
    this.setColour(Blockly.LIST_CATEGORY_HUE);
    ...
    this.appendCollapsedInput().appendTitle('pick').appendTitle(this.getTitleValue('OP'), 'COLLAPSED_TEXT').appendTitle('item');
  },
  onchange: Blockly.WarningHandler.checkErrors,
  typeblock: [{ 
    translatedName: Blockly.LANG_LISTS_PICK_AN_ITEM_TITLE +
        ' ' + Blockly.LANG_LISTS_PICK_RANDOM_TITLE_PICK_RANDOM, 
      dropDown: {
        titleName: 'OP',
        value: 'RANDOM'
      }
    ...
    translatedName: Blockly.LANG_LISTS_PICK_AN_ITEM_TITLE +
        ' ' + Blockly.LANG_LISTS_PICK_FIRST_TITLE_PICK_FIRST,
      dropDown: {
        titleName: 'OP',
        value: 'FIRST'
      }
     ...
     translatedName: Blockly.LANG_LISTS_PICK_AN_ITEM_TITLE +
        ' ' + Blockly.LANG_LISTS_PICK_LAST_TITLE_PICK_LAST,
      dropDown: {
        titleName: 'OP',
        value: 'LAST'
      }
